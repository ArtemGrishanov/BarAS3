package com.bar.ui.panels
{
	...
	public class GoodsPanel extends GameLayer
	{
		...
		public function GoodsPanel(value: GameScene, gType: GoodsType, menu: MainMenuPanel)
		{
			...
			levelTf.defaultTextFormat = new TextFormat(Bar.DEFAULT_FONT, 12, 0xffffff, true);
			...
			expTf.defaultTextFormat = new TextFormat(Bar.DEFAULT_FONT, 12, 0xffffff);
			...
			expBitmap = Images.getImage(Images.SHOP_LEV_PLUS);
