...
//		private var nameTf: TextField;
		...
		public function FriendPanel(value: GameScene, menu: MainMenuPanel, id: String = null, level: Number = NaN)
		{
			super(value);
			width = WIDTH;
			height = HEIGHT;
			...
			if (id) {
				...
				levelIcon.zOrder = 2;
				levelIcon.bitmap = BitmapUtil.scaleImage(Images.getImage(Images.TOOLBAR_LEV_ICO), 0.8, 0.8);
